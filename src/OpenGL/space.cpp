...
int main() {
	...
	Model earth("model/earth/scene.gltf");
	Model mulsanne_ship("model/mulsanne_ship/scene.gltf");
	Model space_fighters("model/space_fighters/scene.gltf");
	Model station("model/space_station/scene.gltf");
